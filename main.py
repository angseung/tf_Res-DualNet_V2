...
for iter in range(iters):
    ...
    start = time.time()
    dummy_output_1 = mobilenet_v1(dummy_input, num_classes=10)
...
print(f"resnet18: [{time_resnet/iters}] mobilenetv1: [{time_mbnet/iters}] resdualnetv1: [{time_rdv1/iters}] resdualnetv2: [{time_rdv2/iters}]")
